              ...
              <div className="relative transition-all product w-full max-w-sm bg-white border border-gray-200 rounded-lg dark:bg-white dark:border-gray-200">
                ...
                <div className="flex items-center justify-between p-3">
                  ...
                  <button
                    ...
                    className="text-white bg-green-500 hover:bg-green-600 focus:ring-1 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-2 py-2 text-center dark:bg-green-500 dark:hover:bg-green-600"
                  >
                ...
                <div className="layer absolute w-full h-1/4 rounded-lg  z-10  justify-center items-center text-center gap-4 flex top-1/3">
                  <i
                    className=" cursor-pointer fa-regular fa-eye fa-md text-black bg-white shadow-xl hover:bg-green-500 hover:text-white transition-all py-3 rounded-md 
                    px-2.5"
                  />
                  <i
                    onClick={() => addtowhishList(product.id)}
                    className=" cursor-pointer fa-regular fa-heart fa-md text-black bg-white shadow-xl  hover:bg-green-500 hover:text-white transition-all py-3 rounded-md px-2.5"
                  />
