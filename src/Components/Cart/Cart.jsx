...
export default function Cart() {
  let { getCartItem, removeCartitem, updatecart, setCart, cart } =
    ...
    <>
      {cart?.numOfCartItems > 0 ? (
        <>
          ...
          <Link to={"/checkout"}>
            <button className="bg-green-500 my-3 py-2 px-3 border border-green-800 text-white rounded-lg hover:bg-green-600">
              <i className="fa-solid fa-wallet px-1"></i>
              Check Out Now
            </button>
          </Link>
        </>
