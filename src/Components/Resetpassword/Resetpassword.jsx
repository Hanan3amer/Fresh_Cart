    ...
    <>
      <div className="row flex md:flex-row flex-col justify-center items-center">
        ...
        <div className="md:w-1/2">
          <h1 className="text-gray-700 font-extrabold text-2xl md:px-36">
            Enter New password
          </h1>

          {ApiError ? (
            <div
              className="py-3 m-2 text-sm text-gray-100 rounded-md bg-red-50 dark:bg-red-100 dark:text-red-500"
              role="alert"
            >
